...
const OptionList = defineComponent({
  ...
  setup(_, { expose, slots }) {
    ...
    // ========================== Active ==========================
    const getEnableActiveIndex = (index: number, offset = 1) => {
    ...
    watch(
      ...
      () => {
        setActive(props.defaultActiveFirstOption !== false ? getEnableActiveIndex(0) : -1);
      },
      { immediate: true },
    );
    ...
    const onKeydown = (event: KeyboardEvent) => {
      ...
      switch (which) {
        ...
        case KeyCode.DOWN: {
          ...
          if (offset !== 0) {
            const nextActiveIndex = getEnableActiveIndex(state.activeIndex + offset, offset);
