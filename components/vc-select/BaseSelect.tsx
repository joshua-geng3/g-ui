...
const baseSelectPrivateProps = () => {
  return {
    ...
    // >>> Search
    searchValue: String,
    /** Link search input width target element */
    ...
    >,
    /** Trigger when search text match the `tokenSeparators`. Will provide  split contenx */
      ...
      watch(
        ...
        () => {
          if (triggerOpen.value) {
            ...
            if (containerWidth.value !== newWidth && newWidth && !Number.isNaN(newWidth)) {
