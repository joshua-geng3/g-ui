...
export default defineComponent({
  ...
  setup(props, { slots, attrs, emit }) {
    ...
    const autoInsertSapce = computed(() => autoInsertSpaceInButton.value !== false);
    ...
    const classes = computed(() => {
      ...
      const sizeClassNameMap = { large: 'lg', small: 'smm', middle: undefined };
      ...
      return {
        ...
        [`${pre}-two-chinese-chars`]: hasTwoCNChar.value && autoInsertSapce.value,
        [`${pre}-block`]: block,
    ...
    return () => {
      ...
      const kids = children.map(child =>
        insertSpace(child, isNeedInserted && autoInsertSapce.value),
      );
