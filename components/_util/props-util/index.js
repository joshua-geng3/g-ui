...
const getSlots = ele => {
  ...
  return { ...slots, ...getScopeSlots(ele)};
};
...
const findDOMNode = instance => {
  let node = instance?.node?.el || (instance && (instance.$el || instance));
...
const getComponentFromProp = (instance, prop, options = instance, execute = true) => {
  if (instance.$createElement) {
    ...
    const slotScope = getScopeSlots(instance)[prop];
